...
Daher eine Idee für die Flächenerhaltende Modifikation eines
...
verschoben. Die alte Position des Parallelogramms ist noch duchsichtig
angedeutet. Schieben wir den Stab noch weiter nach links, so köntte das so
aussehen.
\shorthandoff{"}
\begin{center}
\begin{minipage}{\linewidth}
