...
als ein Stab (derselben Länge, wie die untere Seite).
\shorthandoff{"}
\begin{center}
...
\shorthandon{"}
\newpage
Das ganze kann noch einfacher im Bild dargestellt werden, wenn die negativen
...
und erhalten mit derselben Orientierung wie $e_1\wedge e_2$
...
\begin{tikzpicture}[>=Stealth]
    ...
    \end{scope}
\end{tikzpicture}
\captionof{figure}{Gleichheit der Rotoren in der Ebene}
\label{fig:equalityOfRotors}
\end{minipage}
\end{center}
\shorthandon{"}
\newpage
